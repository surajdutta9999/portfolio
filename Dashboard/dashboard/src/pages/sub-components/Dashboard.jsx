...
const Dashboard = () => {
  ...
  const { softwareApplications, error, message, loading } = useSelector(
  ...
  const handleDeleteSoftwareApp = (id) => {
    setAppId(id);
    dispatch(deleteSoftwareApplication(appId));
  };
                          ...
                          projects.map((element) => {
                            return (
                              <TableRow className="bg-accent" key={element._id}>
                                ...
                                <TableCell>
                                  <Link to={`/manage/projects/${element._id}`}>
                          ...
                          softwareApplications.map((element) => {
                            return (
                              <TableRow className="bg-accent" key={element._id}>
                                ...
                                <TableCell>
                                  <img
                                    src={element.icon && element.svg.url}
                                    alt={element.name}
                                    className="w-7 h-7"
                                  />
                                </TableCell>
